...
| Repo | Purpose | Live? |
|------|---------|-------|
| **`Hilex2030/haps-club`** | The **website**. `index.html` at the root is the daily-recommendations homepage served at https://haps.club (custom domain via GitHub Pages; fallback URL https://hilex2030.github.io/haps-club/). Updated weekly with new picks. Maintained via the `haps-club-website` skill. | Yes — `haps.club` |
...
**Rule:** If the user says "push to the site," "update Haps Club," "add this week's picks," or "haps.club," that's `Hilex2030/haps-club`. If they say "drop this image somewhere I can hotlink it" or "save this artifact," that's `haps-club-assets`.
...
- This repository's `index.html` is a static **asset gallery**, not the Haps Club homepage. The actual homepage lives in `Hilex2030/haps-club` and serves at `haps.club`.
...
4. **Check the repo** — homepage updates belong in `Hilex2030/haps-club` (live at `haps.club`), not here.
...
Website live URL:    https://haps.club
Pages fallback URL:  https://hilex2030.github.io/haps-club/
